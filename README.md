...
## Privacy and Safety
Before publishing, local IP addresses, MAC addresses, hostnames, usernames, product IDs, gateway details, and other sensitive system details were redacted where applicable.
